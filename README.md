...
Diese App ist als Offline-Player konzipiert. Sie müssen die Audio-Dateien selbst bereitstellen. Sie haben zwei Möglichkeiten:

### Option 1: Im App-Bundle (für Entwickler / Release)
Wenn die Audio-Dateien direkt mit der App ausgeliefert werden sollen (Hörbuch-Stil):
1.  Ziehen Sie alle MP3-Dateien in den Xcode-Projektnavigator.
2.  Stellen Sie sicher, dass bei **"Add to targets"** das Häkchen bei `SesliKuran` gesetzt ist.
3.  Die Dateien werden nun beim Download der App mitinstalliert.

### Option 2: Über iTunes / Finder (für Benutzer)
Benutzer können auch nachträglich Dateien hinzufügen:
...
**Wichtig:** Die Dateien müssen folgendes Namensschema haben (egal welche Methode):
`Audio {ID}.mp3`
